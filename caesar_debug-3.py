...
def decryptMessage(message, cipherKey, alphabet):
    ...
    #return encryptMessage(message, cipherKey, alphabet) #issue is that incorrect
    #decryption key is passed to encryptMessage function. Fix is to pass decryptKey
    #instead of cipherKey
